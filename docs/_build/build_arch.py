...
<p class="meta">在武鹏 v1.4 基础上订正命名口径、合并 Atlas、并把 <b>AgentSpec 与 agent-context-storage-matrix consolidate 成同一套模型</b>。本文是跨全家族技术架构 SSOT，落 <code>sudoprivacy/sudostack</code>。开发（PRD + 伪代码）以本文与 matrix 为准。</p>
...
<tr><td><b>P2 SudoServer + P3 SudoMOSS（分列）</b></td><td><b>Sudo Atlas（合并）</b></td><td><code>sudoatlas</code>（装配于 <code>sudostack</code>）</td><td>企业私有化；中控/registry/session 能力来自 base <code>moss</code></td></tr>
...
<tr><td>P6 Sudo Platform</td><td><b>Sudo SaaS</b></td><td><code>sudosaas</code></td><td>公有云 · Atlas 同源 + 编排脑 + 三方接入</td></tr>
...
<tr><td><b>Sudo Atlas</b></td><td>企业私有化平台：托管 Runtime + Agent 治理 + 中控/编排/验收</td><td>企业内网（部署两次：管理面 + 执行面）</td><td><code>sudoatlas</code> / <code>sudostack</code></td></tr>
...
<tr><td><b>Sudo SaaS</b></td><td>公有云 Atlas 同源 + 编排脑 + 三方接入（锐锢/中资等投标）</td><td>数牍腾讯云</td><td><code>sudosaas</code></td></tr>
...
<li><b>Atlas ≠ 云端</b>：Atlas 是企业私有化。公有云是 SaaS（Atlas 同源）。两者共享 base 产品与 <code>sudostack</code> 装配。</li>
...
<tr><td><b>本文</b>（产品架构说明书）</td><td>跨全家族技术架构</td><td><code>sudostack</code></td><td>产品分层 · 契约口径 · AgentSpec 语义</td></tr>
...
<p class="foot-note">订正版 v2.0 · 基于武鹏 v1.4 + agent-context-storage-matrix + v4.4 命名口径 · 落 sudoprivacy/sudostack · sudowork-win-pc-3</p>
'''
